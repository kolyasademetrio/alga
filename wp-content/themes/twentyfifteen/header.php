...
<div class="wrapper__main">
	<div class="content__main">
		...
		<div id="main" class="site__main">
			<a href="#header" class="ancor__up"></a>
			
			<div id="cart__popup" class="mfp-hide cart__popup">
				<div class="entry-title">Корзина</div>
				<?php
				do_action( 'woocommerce_before_cart' ); ?>
				<div class="woocommerce-cart-form__message"></div>
				<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post" dima-form-header>
					...
					<div class="cart__popup__tableFooter">
						...
						<?php if ( wc_coupons_enabled() ) { ?>
							<div class="coupon">
								<label for="coupon_code"><?php esc_html_e( 'Код на скидку:', 'woocommerce' ); ?></label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Введите код', 'woocommerce' ); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'Применить код', 'woocommerce' ); ?></button>
