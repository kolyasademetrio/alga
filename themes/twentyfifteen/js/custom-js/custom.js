...
function plusMinus(){
    ...
    console.log( $('#cart__popup .quantity').find('.button').length );
...
jQuery(document).ready(function($){
    ...
    /* После загрузки страницы Checkout Page происходит обновление корзины и данных о товаре(вставляем кнопки +/-) */
